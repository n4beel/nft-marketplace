...
describe("NFTMarketplace", function () {
  it("Should create and execute market sales", async function () {
    ...
    const listingPrice = await market.getListingPrice().then(price => price.toString());
    ...
    await market.createToken("https://www.mytokenlocation1.com", auctionPrice, { value: listingPrice });
    await market.createToken("https://www.mytokenlocation2.com", auctionPrice, { value: listingPrice });
    await market.createToken("https://www.mytokenlocation3.com", auctionPrice, { value: listingPrice });
    await market.createToken("https://www.mytokenlocation4.com", auctionPrice, { value: listingPrice });
